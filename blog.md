...
<div class="content-section">
    ...
    <p>
        This work contributes to understanding how research and diversity in scientific practices can shape the future of green technology development. I set up a research plan from scratch, including the initial coding of large-scale patent and publication datasets, data cleaning, and the development of a statistically robust analysis strategy using Python and The R Project for Statistical Computing. In this respect, this PhD work shows my ability to work hard, meticulously analyse large and complex datasets, and present findings to both scientific and non-specialist audiences through written reports and oral presentations. 
    </p>
