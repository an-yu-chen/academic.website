...
<div style="text-align: center; padding: 40px; background: linear-gradient(135deg, #8e44ad, #3498db); color: white; border-radius: 10px;">
  <h1 style="font-size: 2.8rem; margin-bottom: 20px; font-family: 'Playfair Display', serif;">My Publications</h1>
</div>

<div style="padding: 30px; font-size: 1.2rem; line-height: 1.8; color: #2c3e50;">

  <h2 style="font-size: 2rem; color: #8e44ad; text-align: center; margin-bottom: 20px;">Working Papers</h2>

  <p style="background: #f9f9f9; padding: 20px; border-left: 5px solid #3498db; margin: 15px auto; max-width: 800px; border-radius: 10px;">
  ...
  <p style="background: #f9f9f9; padding: 20px; border-left: 5px solid #2ecc71; margin: 15px auto; max-width: 800px; border-radius: 10px;">
    <strong>Chen, A. Y., Lawson, C., & Massini, S.</strong> (Year).  
    <em>Understanding the characteristics of green scientific knowledge base and connections to technologies</em>  
    [Working paper]. Targeted journal: <strong>Research Policy (RP)</strong>.
  </p>

  <p style="background: #f9f9f9; padding: 20px; border-left: 5px solid #e74c3c; margin: 15px auto; max-width: 800px; border-radius: 10px;">
    <strong>Chen, A. Y., Lawson, C., & Massini, S.</strong> (Year).  
  ...
  <h2 style="font-size: 2rem; color: #8e44ad; text-align: center; margin-bottom: 20px;">Conference and Seminar Papers (Recent)</h2>
